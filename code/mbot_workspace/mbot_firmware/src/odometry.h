 ...
 * @param[in] imu       IMU reading for obtaining filtered yaw orientation.
 ...
 * @return int          Returns 0 on success
 */
int mbot_calculate_odometry(serial_twist2D_t mbot_vel, serial_mbot_imu_t imu, float dt, serial_pose2D_t *odometry);
